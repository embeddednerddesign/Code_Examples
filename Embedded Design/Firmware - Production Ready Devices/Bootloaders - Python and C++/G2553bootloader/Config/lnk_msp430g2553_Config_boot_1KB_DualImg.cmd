...
_FLASHDOWN_START = 0xC000;                      /* Start of Flash for G2553 is 0xC000(download area) */
__Flash_Start = 0xE000;                         /* Start of App Flash for G2553 is 0xE000            */
__Flash_End = 0xFFFF;                           /* End of Flash                                      */
    /* Reserved Flash locations for Bootloader Area */
    __Boot_Start = 0xFC00;                          /* Boot reserves 1KB (0xFC00-0xFFFF)            */
    ...
    _AppChecksumDown = (_FLASHDOWN_START);          /* CRC16 of Application in download area        */
    _AppChecksumDown_8 = (_FLASHDOWN_START+2);      /* CRC8 of Application in download area         */
    _AppChecksum = (__Flash_Start);	                /* CRC16 of Application                         */
    _AppChecksum_8 = (__Flash_Start+2);             /* CRC8 of Application                          */
    _App_StartDown = (_FLASHDOWN_START+3);          /* Application download area                    */
    _App_Start = (__Flash_Start+3);                 /* Application Area                             */
    _App_EndDown = (__Flash_Start-1);               /* End of download area (before boot)           */
