...
BSL_JUMP_TO_APP         = 0x1c    # Force target to execute its app
...
class BSL5(object):
    ...
    def BSL_JUMP_TO_APP(self):
        self.bsl(BSL_JUMP_TO_APP, expect=None)
#         answer = self.bsl(BSL_JUMP_TO_APP, expect=None)
#         self.check_answer(answer)
    ...
    def jump_to_app(self):
        """\
        force the processor to jump from the bootlaod code to the app code
        """
        self.BSL_JUMP_TO_APP()
#         return self.BSL_VERSION()
